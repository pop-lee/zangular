        ...
        link: function(scope, element, attrs) {
          ...
          var eachTreeScope = function(nodeScope,fn) {
            ...
            if(ret == "return") {
              ...
              return eachAllChildScope(nodeScope.$childNodesScope,fn);
            }
          }
          ...
          var getScopeByData = function(data) {
            ...
            for(var nsKey in scope.$$childHead.$nodesScope.$nodesMap){
              var ns = scope.$$childHead.$nodesScope.$nodesMap[nsKey];
